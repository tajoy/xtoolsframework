...
public abstract class ExBaseService extends BaseService implements Loggable {
    final static String TAG = ExBaseService.class.getSimpleName();
    ...
    ActivityInfo nowActivityInfo;
    ComponentName nowComponentName;

    public static ExBaseService getInstance() {
        return instance;
    }

    private static ExBaseService instance;
