...
public final class ReflectUtils implements Loggable {
    private static final Loggable logger = Loggable.fromClass(ReflectUtils.class);
            ...
            for (Method method : clz.getDeclaredMethods()) {
                ...
                if (method.getName().equals(methodName) && ClassUtils.isAssignable(parameterTypes, method.getParameterTypes(), true)) {
                    ...
                    if (bestMatch == null || MemberUtils.compareParameterTypes(
                            MemberUtils.Executable.of(method),
                            MemberUtils.Executable.of(bestMatch),
                            parameterTypes) < 0) {
                        bestMatch = method;
                    }
                }
    ...
    public static boolean isInstance(Object object, String className) {
        ...
        } while (cls != null && !clsName.equals("Object"));
    ...
    public static Class<?>[] getParameterClasses(ClassLoader classLoader, Object[] parameterTypesAndCallback) {
        ...
        for (int i = parameterTypesAndCallback.length - 1; i >= 0; i--) {
            ...
            if (isInstance(type, "de.robv.android.xposed.XC_MethodHook"))
                continue;
    ...
    public static Constructor<?> findConstructorBestMatch(Class<?> clazz, Class<?>... parameterTypes) {
        ...
        for (Constructor<?> constructor : constructors) {
            ...
            if (ClassUtils.isAssignable(parameterTypes, constructor.getParameterTypes(), true)) {
                // get accessible version of method
                if (bestMatch == null || MemberUtils.compareParameterTypes(
                        MemberUtils.Executable.of(constructor),
                        MemberUtils.Executable.of(bestMatch),
                        parameterTypes) < 0) {
